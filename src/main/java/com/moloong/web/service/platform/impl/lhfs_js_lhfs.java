 ...
 */
public class lhfs_js_lhfs implements ReflectionService {
    @Override
...
//        String loginurl = "http://101.37.23.196:8081/interface_redis/login_49you?pf=" + agent + "&username=" + username + "&serverId=" + serverid + "&time=" + time + "&sign=" + sign + "&showlogin=0&adult=" + adult+"&channel_user_id="+username;
